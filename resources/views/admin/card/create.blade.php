...
<div class="container-fluid">
  <h1 class="h3 mb-4 text-gray-800 w-600">Add Card</h1>
  <div class="d-sm-flex align-items-center justify-content-between mb-4">

    <div class="card shadow mb-4">
      <div class="card-body">

        <form method="POST" action="{{ url('admin/card/save-category') }}" enctype="multipart/form-data">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-7">
              <select name="blockCategory" class="form-control">
                ...
                @foreach($data['Blockcategory'] as $id => $name)
