                        ...
                        <table bgcolor="#ffffff" class="tophead" border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="padding: 0;">
                            ...
                            <tr>
                                ...
                                <p
                                        ...
                                        "
                                    >
                                    The below prospect assigned to you has requested a call back. Kindly find time and contact the customer.
                                    </p> <br>
                                    <p
                                        style="
                                            text-align: left;
                                    ...
                                    <p
                                        ...
                                        "
                                    >
                                    Call Back regarding: - {{$details['message']}}
                                    </p> 
                                    <p
                                        style="
                                            text-align: left;
                                        ...
                                        "
                                    >
                                    Time of request for call back: - {{$details['time']}}
                                    </p> 
                                </td>
                            </tr>
                            <tr>
