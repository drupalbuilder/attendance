...
class ReminderFeedbackSubmission extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'reminderfeedback:submission';
     ...
     * @var string
     */
    protected $description = 'Reminder for Feedback submission';
